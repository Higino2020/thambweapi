...
@section('thamb')
                    ...
                    @foreach (App\Models\Musica::all() as $item)
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ route('musica.show', $item->id) }} " class="bts"><i
    ...
    <div class="modal fade" id="Musicas" tabindex="-1" data-bs-keyboard="false" role="dialog"
                ...
                <div class="modal-body">
                    <form action="{{ route('musica.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-12">
                                <label for="ficheiro" class="mb-2">Ficheiro da Música</label>
